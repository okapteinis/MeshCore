...
- **Save it somewhere you'll find it later** — a password manager, a note next to your other device credentials, whatever you already use. There's no "forgot password" email or account recovery for a LoRa repeater; the fix below works, but it's easiest to just not lose it.
